    ...
    return(
      ...
      <div className="">
        ...
        <Image
          ...
          <p className='text-[1rem]'>Parabéns <strong className='text-green-400'>{productFinal.info.customerName?.toUpperCase()}</strong>, você adquiriu seu {productFinal.info.product.name} <span>475ml</span> <strong>{productFinal.info.product.cor}</strong></p>
        </div>
        <Link
           href={`/`}
